#############################################################################
# Makefile for building: neon-logout
# Generated by qmake (3.1) (Qt 5.15.7)
# Project:  neon-logout.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile neon-logout.pro
#############################################################################
...
SOURCES       = neon-logout.cpp 
OBJECTS       = neon-logout.o
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		neon-logout.pro  neon-logout.cpp
QMAKE_TARGET  = neon-logout
DESTDIR       = 
TARGET        = neon-logout
...
Makefile: neon-logout.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		neon-logout.pro
	$(QMAKE) -o Makefile neon-logout.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents neon-logout.cpp $(DISTDIR)/
...
neon-logout.o: neon-logout.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o neon-logout.o neon-logout.cpp
